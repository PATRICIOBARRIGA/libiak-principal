HA$PBExportHeader$w_rep_facturas_vencidas_consolidado.srw
$PBExportComments$Si.Facturas vencidas del sistema
forward
global type w_rep_facturas_vencidas_consolidado from w_sheet_1_dw_rep
end type
type dw_sel_rep from datawindow within w_rep_facturas_vencidas_consolidado
end type
end forward
...
global w_rep_facturas_vencidas_consolidado w_rep_facturas_vencidas_consolidado

type variables

end variables

on w_rep_facturas_vencidas_consolidado.create
int iCurrent
call super::create
...
on w_rep_facturas_vencidas_consolidado.destroy
call super::destroy
...
//	dw_datos.DataObject = 'facturas_vencidas_unnomotors'
	dw_datos.DataObject = 'facturas_vencidas_redcolor_consolidado'
	dw_datos.SetTransObject(sqlca)
	f_recupera_empresa(dw_datos,"ep_codigo")
	dw_datos.Modify("datawindow.detail.height = '70'  datawindow.print.preview='yes' datawindow.print.preview.zoom='100'")
	dw_datos.Retrieve(integer(str_appgeninfo.empresa),fec_ini,fec_fin)
end if
...
type dw_datos from w_sheet_1_dw_rep`dw_datos within w_rep_facturas_vencidas_consolidado
integer x = 0
integer y = 168
integer width = 3611
integer height = 1748
string dataobject = "facturas_vencidas_redcolor_consolidado"
boolean border = true
...
type dw_report from w_sheet_1_dw_rep`dw_report within w_rep_facturas_vencidas_consolidado
integer x = 9
integer y = 168
integer width = 219
integer height = 140
...
type dw_asiento from w_sheet_1_dw_rep`dw_asiento within w_rep_facturas_vencidas_consolidado
integer x = 274
integer y = 176
integer width = 265
integer height = 128
