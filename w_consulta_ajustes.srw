HA$PBExportHeader$w_consulta_ajustes.srw
$PBExportComments$Si.Vale
forward
global type w_consulta_ajustes from window
end type
type dw_2 from datawindow within w_consulta_ajustes
end type
type cb_1 from commandbutton within w_consulta_ajustes
end type
type st_dw_mode from statictext within w_consulta_ajustes
end type
type cb_action from commandbutton within w_consulta_ajustes
end type
type dw_1 from datawindow within w_consulta_ajustes
end type
end forward
...
string title = "Consulta de ajustes"
...
global w_consulta_ajustes w_consulta_ajustes
...
f_recupera_empresa(dw_1,"tm_codigo")
...
integer taborder = 20
boolean titlebar = true
string title = "Detalle de ajuste"
...
integer taborder = 10
string title = "none"
string dataobject = "d_consul_ajustes"
boolean vscrollbar = true
...
ls_numero      = This.GetItemString(currentrow,"aj_numero")
ls_sucodigo    = This.GetItemString(currentrow,"su_codigo")
ls_bocodigo    = This.GetItemString(currentrow,"bo_codigo")
ls_tmcodigo    = This.GetItemString(currentrow,"tm_codigo")
ls_tmtipo      = This.GetItemString(currentrow,"tm_ioe")

dw_2.Retrieve(str_appgeninfo.empresa,ls_sucodigo,ls_tmcodigo,ls_tmtipo,ls_numero)
...
String  ls_numero,ls_sucodigo,ls_bocodigo,ls_tmcodigo,ls_tmtipo

if rowcount  =  0 then return 
ls_numero    = This.GetItemString(1,"aj_numero")
ls_sucodigo  = This.GetItemString(1,"su_codigo")
ls_bocodigo  = This.GetItemString(1,"bo_codigo")
ls_tmcodigo  = This.GetItemString(1,"tm_codigo")
ls_tmtipo  = This.GetItemString(1,"tm_ioe")
dw_2.Retrieve(str_appgeninfo.empresa,ls_sucodigo,ls_tmcodigo,ls_tmtipo,ls_numero)
end event
