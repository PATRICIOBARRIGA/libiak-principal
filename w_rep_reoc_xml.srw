HA$PBExportHeader$w_rep_reoc_xml.srw
$PBExportComments$Si.
forward
global type w_rep_reoc_xml from w_sheet_1_dw_rep
end type
type rb_1 from radiobutton within w_rep_reoc_xml
end type
type cb_3 from commandbutton within w_rep_reoc_xml
end type
type dw_1 from datawindow within w_rep_reoc_xml
end type
type st_1 from statictext within w_rep_reoc_xml
end type
type rb_2 from radiobutton within w_rep_reoc_xml
end type
type rb_3 from radiobutton within w_rep_reoc_xml
end type
type rb_4 from radiobutton within w_rep_reoc_xml
end type
type sle_3 from singlelineedit within w_rep_reoc_xml
end type
type st_5 from statictext within w_rep_reoc_xml
end type
type sle_1 from singlelineedit within w_rep_reoc_xml
end type
type st_6 from statictext within w_rep_reoc_xml
end type
type sle_2 from singlelineedit within w_rep_reoc_xml
end type
type st_7 from statictext within w_rep_reoc_xml
end type
type cb_1 from commandbutton within w_rep_reoc_xml
end type
type st_8 from statictext within w_rep_reoc_xml
end type
type dw_2 from datawindow within w_rep_reoc_xml
end type
type cb_2 from commandbutton within w_rep_reoc_xml
end type
type cb_4 from commandbutton within w_rep_reoc_xml
end type
type dw_3 from datawindow within w_rep_reoc_xml
end type
type rb_5 from radiobutton within w_rep_reoc_xml
end type
type rb_6 from radiobutton within w_rep_reoc_xml
end type
end forward
...
global w_rep_reoc_xml w_rep_reoc_xml

on w_rep_reoc_xml.create
int iCurrent
call super::create
...
type dw_datos from w_sheet_1_dw_rep`dw_datos within w_rep_reoc_xml
integer x = 5
integer y = 292
integer width = 5682
integer height = 1600
...
type dw_report from w_sheet_1_dw_rep`dw_report within w_rep_reoc_xml
integer x = 192
integer y = 924
integer taborder = 60
...
type dw_asiento from w_sheet_1_dw_rep`dw_asiento within w_rep_reoc_xml
integer x = 1134
integer y = 912
integer width = 722
integer height = 564
