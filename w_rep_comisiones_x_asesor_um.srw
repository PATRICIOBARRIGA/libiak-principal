HA$PBExportHeader$w_rep_comisiones_x_asesor_um.srw
$PBExportComments$Si.Con nueva pol$$HEX1$$ed00$$ENDHEX$$tica de comisiones...
forward
global type w_rep_comisiones_x_asesor_um from w_sheet_1_dw_rep
end type
type rb_1 from radiobutton within w_rep_comisiones_x_asesor_um
end type
type rb_2 from radiobutton within w_rep_comisiones_x_asesor_um
end type
type st_1 from statictext within w_rep_comisiones_x_asesor_um
end type
type cbx_1 from checkbox within w_rep_comisiones_x_asesor_um
end type
type st_2 from statictext within w_rep_comisiones_x_asesor_um
end type
type cbx_2 from checkbox within w_rep_comisiones_x_asesor_um
end type
type cbx_3 from checkbox within w_rep_comisiones_x_asesor_um
end type
type cbx_4 from checkbox within w_rep_comisiones_x_asesor_um
end type
type cbx_5 from checkbox within w_rep_comisiones_x_asesor_um
end type
end forward
...
global w_rep_comisiones_x_asesor_um w_rep_comisiones_x_asesor_um

on w_rep_comisiones_x_asesor_um.create
int iCurrent
call super::create
...
on w_rep_comisiones_x_asesor_um.destroy
call super::destroy
destroy(this.rb_1)
destroy(this.rb_2)
destroy(this.st_1)
...
elseif cbx_2.checked  then /*Mercader$$HEX1$$ed00$$ENDHEX$$a*/
 	     if cbx_3.checked then  /*Comisiones*/
		      if rb_1.checked then dw_datos.dataobject = 'd_rep_com_mercaderia_asesor_contado_um'
	           if rb_2.checked then dw_datos.dataobject = 'd_rep_com_mercaderia_asesor_credito_um' 
	     elseif cbx_4.checked then /*Recuperaci$$HEX1$$f300$$ENDHEX$$n cartera*/
		      if rb_1.checked then dw_datos.dataobject = 'd_rep_np_recp_mer_asesor_contado_um'
	           if rb_2.checked then dw_datos.dataobject = 'd_rep_np_recp_mer_asesor_credito_um'
	     end if	
...
type dw_datos from w_sheet_1_dw_rep`dw_datos within w_rep_comisiones_x_asesor_um
integer x = 0
integer y = 320
integer width = 2647
integer height = 1208
...
type dw_report from w_sheet_1_dw_rep`dw_report within w_rep_comisiones_x_asesor_um
integer y = 724
end type

type dw_asiento from w_sheet_1_dw_rep`dw_asiento within w_rep_comisiones_x_asesor_um
end type
