HA$PBExportHeader$w_compras_cxp3_pruebas.srw
$PBExportComments$Si.Movimientos de credito en CXP... (Facturas de servicio). Vale
forward
global type w_compras_cxp3_pruebas from w_sheet_1_dw_maint
end type
type dw_ubica from datawindow within w_compras_cxp3_pruebas
end type
type em_1 from editmask within w_compras_cxp3_pruebas
end type
type em_2 from editmask within w_compras_cxp3_pruebas
end type
type st_2 from statictext within w_compras_cxp3_pruebas
end type
type st_3 from statictext within w_compras_cxp3_pruebas
end type
type dw_a from datawindow within w_compras_cxp3_pruebas
end type
type dw_c from datawindow within w_compras_cxp3_pruebas
end type
type dw_anexo from datawindow within w_compras_cxp3_pruebas
end type
type dw_b from datawindow within w_compras_cxp3_pruebas
end type
type dw_3 from datawindow within w_compras_cxp3_pruebas
end type
type cb_1 from commandbutton within w_compras_cxp3_pruebas
end type
type st_5 from statictext within w_compras_cxp3_pruebas
end type
type st_6 from statictext within w_compras_cxp3_pruebas
end type
type dw_asiento from uo_dw_basic within w_compras_cxp3_pruebas
end type
type dw_cab from datawindow within w_compras_cxp3_pruebas
end type
type cb_2 from commandbutton within w_compras_cxp3_pruebas
end type
type dw_cc from uo_dw_comprobante within w_compras_cxp3_pruebas
end type
type dw_2 from datawindow within w_compras_cxp3_pruebas
end type
type cb_3 from commandbutton within w_compras_cxp3_pruebas
end type
type cb_4 from commandbutton within w_compras_cxp3_pruebas
end type
type st_8 from statictext within w_compras_cxp3_pruebas
end type
type st_9 from statictext within w_compras_cxp3_pruebas
end type
type st_4 from commandbutton within w_compras_cxp3_pruebas
end type
type st_leyenda from statictext within w_compras_cxp3_pruebas
end type
type st_10 from statictext within w_compras_cxp3_pruebas
end type
type dw_op from datawindow within w_compras_cxp3_pruebas
end type
type cb_5 from commandbutton within w_compras_cxp3_pruebas
end type
type sle_1 from singlelineedit within w_compras_cxp3_pruebas
end type
type shl_1 from statichyperlink within w_compras_cxp3_pruebas
end type
type st_1 from statictext within w_compras_cxp3_pruebas
end type
type dw_4 from datawindow within w_compras_cxp3_pruebas
end type
type sle_2 from singlelineedit within w_compras_cxp3_pruebas
end type
type st_11 from statictext within w_compras_cxp3_pruebas
end type
type ln_1 from line within w_compras_cxp3_pruebas
end type
type dw_crenocru from datawindow within w_compras_cxp3_pruebas
end type
type cb_6 from commandbutton within w_compras_cxp3_pruebas
end type
type dw_1 from datawindow within w_compras_cxp3_pruebas
end type
end forward
...
global w_compras_cxp3_pruebas w_compras_cxp3_pruebas
...
on w_compras_cxp3_pruebas.create
int iCurrent
call super::create
...
on w_compras_cxp3_pruebas.destroy
call super::destroy
...
type dw_datos from w_sheet_1_dw_maint`dw_datos within w_compras_cxp3_pruebas
integer x = 50
integer y = 128
integer width = 6034
integer height = 1244
...
select count(1) into :ll_count from cp_movim where tv_codigo = 'C';
...
type dw_report from w_sheet_1_dw_maint`dw_report within w_compras_cxp3_pruebas
integer x = 23
integer y = 12
integer width = 4978
integer height = 2764
