HA$PBExportHeader$w_rep_reimprimir_nc.srw
$PBExportComments$Si.
forward
global type w_rep_reimprimir_nc from w_sheet_1_dw_rep
end type
type dw_param from datawindow within w_rep_reimprimir_nc
end type
end forward
...
global w_rep_reimprimir_nc w_rep_reimprimir_nc
...
on w_rep_reimprimir_nc.destroy
call super::destroy
...
//ll_nreg = dw_datos.Retrieve(is_estado,str_appgeninfo.empresa,str_appgeninfo.sucursal,string(il_venumero))
//If ll_nreg = 0 Then 
//messagebox("Atenci$$HEX1$$f300$$ENDHEX$$n","Error de la Nota de Cr$$HEX1$$e900$$ENDHEX$$dito pues no existen datos para imprimir")	
//return
//end if

dw_datos.Modify("DataWindow.Footer.Height=2600")
dw_datos.print()	
...
type dw_datos from w_sheet_1_dw_rep`dw_datos within w_rep_reimprimir_nc
integer x = 0
integer y = 244
integer width = 3483
integer height = 1688
...
type dw_report from w_sheet_1_dw_rep`dw_report within w_rep_reimprimir_nc
integer y = 164
end type

type dw_asiento from w_sheet_1_dw_rep`dw_asiento within w_rep_reimprimir_nc
end type
...
If   not isnull(is_preimpreso) Then	
	...
	Else
		is_estado = '10'
	End if
	if dw_datos.Retrieve(is_estado,str_appgeninfo.empresa,str_appgeninfo.sucursal,il_venumero ) <= 0 then
		messageBox('Atenci$$HEX1$$f300$$ENDHEX$$n','Nota de Cr$$HEX1$$e900$$ENDHEX$$dito no registrada en esta sucursal')
		return
	end if
