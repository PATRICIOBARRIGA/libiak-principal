...
forward
global type w_consulta_ventas from window
end type
type cb_2 from commandbutton within w_consulta_ventas
end type
type dw_2 from datawindow within w_consulta_ventas
end type
type cb_1 from commandbutton within w_consulta_ventas
end type
type st_dw_mode from statictext within w_consulta_ventas
end type
type cb_action from commandbutton within w_consulta_ventas
end type
type dw_1 from datawindow within w_consulta_ventas
end type
end forward
...
string dataobject = "dw_consulta_ventas"
