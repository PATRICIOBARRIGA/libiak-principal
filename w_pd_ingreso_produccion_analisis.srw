HA$PBExportHeader$w_pd_ingreso_produccion_analisis.srw
$PBExportComments$Genera ordenes de producccion a partir de los productos  ingresados al inventario.
forward
global type w_pd_ingreso_produccion_analisis from w_sheet_master_detail
end type
type dw_ubica from datawindow within w_pd_ingreso_produccion_analisis
end type
type dw_movim from datawindow within w_pd_ingreso_produccion_analisis
end type
type st_2 from statictext within w_pd_ingreso_produccion_analisis
end type
type st_3 from statictext within w_pd_ingreso_produccion_analisis
end type
type dw_1 from datawindow within w_pd_ingreso_produccion_analisis
end type
type cb_1 from commandbutton within w_pd_ingreso_produccion_analisis
end type
type dw_rta from datawindow within w_pd_ingreso_produccion_analisis
end type
type uo_egprd from uo_ajustes within w_pd_ingreso_produccion_analisis
end type
type dw_mp from datawindow within w_pd_ingreso_produccion_analisis
end type
type cb_rev from commandbutton within w_pd_ingreso_produccion_analisis
end type
type shl_1 from statichyperlink within w_pd_ingreso_produccion_analisis
end type
type shl_2 from statichyperlink within w_pd_ingreso_produccion_analisis
end type
type st_4 from statictext within w_pd_ingreso_produccion_analisis
end type
type st_5 from statictext within w_pd_ingreso_produccion_analisis
end type
type sle_1 from singlelineedit within w_pd_ingreso_produccion_analisis
end type
type st_6 from statictext within w_pd_ingreso_produccion_analisis
end type
type st_nombre from statictext within w_pd_ingreso_produccion_analisis
end type
type cb_2 from commandbutton within w_pd_ingreso_produccion_analisis
end type
type st_1 from statictext within w_pd_ingreso_produccion_analisis
end type
type em_1 from editmask within w_pd_ingreso_produccion_analisis
end type
type cb_3 from commandbutton within w_pd_ingreso_produccion_analisis
end type
end forward
...
global w_pd_ingreso_produccion_analisis w_pd_ingreso_produccion_analisis

type variables
string  is_nombodega,is_empleado,is_mensaje,is_codant1
boolean ib_ponmensaje, ib_not_item_found = FALSE, ib_not_stock_found = FALSE,ib_not_more_stock = FALSE,ib_genera_ordprd = false
decimal id_stock
long il_numero
...
on w_pd_ingreso_produccion_analisis.create
int iCurrent
call super::create
...
this.Control[iCurrent+17]=this.st_nombre
...
on w_pd_ingreso_produccion_analisis.destroy
call super::destroy
...
uo_egprd.ib_genera_ordprd = false
...
type dw_master from w_sheet_master_detail`dw_master within w_pd_ingreso_produccion_analisis
integer x = 37
integer y = 272
integer width = 2647
integer height = 396
...
type dw_detail from w_sheet_master_detail`dw_detail within w_pd_ingreso_produccion_analisis
integer x = 37
integer y = 748
integer width = 2651
integer height = 1192
...
type dw_report from w_sheet_master_detail`dw_report within w_pd_ingreso_produccion_analisis
integer x = 50
integer y = 832
integer width = 2281
integer height = 996
...
event clicked;string ls_coditem,ls_pepa,ls_nombre,ls_itcodigo
...
INTO :ls_coditem,:ls_nombre
FROM IN_ITEM
WHERE IT_CODANT = :sle_1.text;

lc_cantidad_producida = dec(em_1.text)

//1.- Ingreso de cantidad para realizar el ajuste de EGRESO
...
//Detalle del egreso
ll_new = uo_egprd.dw_detail.insertrow(0)		
uo_egprd.dw_detail.Object.it_codigo[ll_new]               = ls_coditem
uo_egprd.dw_detail.Object.codant[ll_new]                  = sle_1.text
//uo_egprd.dw_detail.Object.it_kit[ll_new]                     = dw_rta.object.it_kit[j]
uo_egprd.dw_detail.Object.it_nombre[ll_new]              = ls_nombre
uo_egprd.dw_detail.Object.da_cantidad[ll_new]           = lc_cantidad_producida
uo_egprd.dw_detail.object.da_costo[ll_new]                = lc_costo  



//2.- Ingresar cantidades para realizar el ajuste de ingreso
dw_master.reset()
dw_detail.reset()
	 ...
	 //Si no tiene formulaci$$HEX1$$f300$$ENDHEX$$n continuar al siguiente item
		...
		ll_new = dw_master.insertrow(0)
//		uo_egprd.dw_master.object.or_codigo[ll_new]  = 1
		dw_master.object.em_codigo[ll_new]= str_appgeninfo.empresa
		dw_master.object.su_codigo[ll_new] = str_appgeninfo.sucursal 
		dw_master.object.bo_codigo[ll_new] = str_appgeninfo.seccion
		dw_master.object.aj_fecha[ll_new]   = f_hoy()
...
long textcolor = 128
long backcolor = 67108864
string text = "ORDENES DE PRODUCCION"
boolean focusrectangle = false
end type
...
INTO :ls_nombre
FROM IN_ITEM
WHERE IT_CODANT = :this.text;

If sqlca.sqlcode <> 0   then
	Messagebox("Atencion","No existe el codigo de producto")
return
end if
...
string facename = "Arial"
long backcolor = 67108864
string text = "Seleccione el c$$HEX1$$f300$$ENDHEX$$digo que desea procesar"
boolean focusrectangle = false
end type
...
boolean underline = true
long backcolor = 67108864
string text = "descripcion del producto"
boolean focusrectangle = false
end type
...
fontfamily fontfamily = swiss!
string facename = "Arial"
string text = "Ver formulaci$$HEX1$$f300$$ENDHEX$$n"
end type

event clicked;	String ls_pepa,ls_codant
	long ll_reg,ll_new
	Decimal{2} lc_cantid

	ls_codant       = sle_1.text
	lc_cantid        = dec(em_1.text)
	...
	dw_rta.visible = true
	ll_reg    = dw_rta.retrieve(str_appgeninfo.empresa,str_appgeninfo.sucursal,ls_pepa,'C', lc_cantid)
	if ll_reg = 0 then dw_rta.retrieve(str_appgeninfo.empresa,str_appgeninfo.sucursal,ls_pepa,'F', lc_cantid)
...
fontfamily fontfamily = swiss!
string facename = "Arial"
string text = "Ingresar cantidades"
end type

event clicked;Long ll_new

//Cargar formulacion en los ajustes
	 is_mov = 'S'  //Indica que el tipo de movimiento es una reversion, con el objetivo de dar prioridad a la secuencia de grabaci$$HEX1$$f300$$ENDHEX$$n.

         // Se carga cantidades para realizar el ajuste de INGRESO
		//1. Datos de la cabecera del ajuste de ingreso	
		dw_master.reset()
		//datos del ajuste
		ll_new = dw_master.insertrow(0)
		dw_master.object.em_codigo[ll_new] = str_appgeninfo.empresa
...
//		dw_master.Object.or_codigo[ll_new]  = is_numord
		...
		ll_new = dw_detail.insertrow(0)
         ...
         //Ingresa la cantidad producida por formula
         cb_1.triggerevent(clicked!)      
