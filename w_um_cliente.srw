HA$PBExportHeader$w_um_cliente.srw
$PBExportComments$1
forward
global type w_um_cliente from w_sheet_1_dw_maint
end type
type dw_ubica from datawindow within w_um_cliente
end type
end forward
...
global w_um_cliente w_um_cliente
...
type dw_datos from w_sheet_1_dw_maint`dw_datos within w_um_cliente
event ue_nextfield pbm_dwnprocessenter
integer x = 41
integer y = 60
integer width = 3195
integer height = 2060
string dataobject = "d_um_cliente"
...
event dw_datos::updatestart;/*Validar la excension de IVA*/
Char lch_exiva 
string ls_rucci
...
ls_rucci     = this.object.ce_rucci[ll_row]
lch_exiva  = this.object.ce_exiva[ll_row]
if mid(ls_rucci,3,1) = '6' and lch_exiva = '' or isnull(lch_exiva) then
Messagebox("Atenci$$HEX1$$f300$$ENDHEX$$n","Parece ser que este cliente es P$$HEX1$$fa00$$ENDHEX$$blico y no puede estar exento de IVA...<Por favor verifique!> ")	
return 1
end if
return 0
...
type dw_report from w_sheet_1_dw_maint`dw_report within w_um_cliente
integer x = 1819
integer y = 1768
integer width = 562
integer height = 96
