HA$PBExportHeader$w_enviar_transferencia_unomotor.srw
$PBExportComments$Trabajando actualmente
forward
global type w_enviar_transferencia_unomotor from w_sheet_master_detail
end type
type dw_ubica from datawindow within w_enviar_transferencia_unomotor
end type
type cb_1 from commandbutton within w_enviar_transferencia_unomotor
end type
type dw_1 from datawindow within w_enviar_transferencia_unomotor
end type
type dw_movim from datawindow within w_enviar_transferencia_unomotor
end type
type st_1 from statictext within w_enviar_transferencia_unomotor
end type
type st_time from statictext within w_enviar_transferencia_unomotor
end type
type st_3 from statictext within w_enviar_transferencia_unomotor
end type
type st_leyenda1 from statictext within w_enviar_transferencia_unomotor
end type
type st_leyenda2 from statictext within w_enviar_transferencia_unomotor
end type
type st_leyenda3 from statictext within w_enviar_transferencia_unomotor
end type
type st_2 from statictext within w_enviar_transferencia_unomotor
end type
type st_4 from statictext within w_enviar_transferencia_unomotor
end type
type st_5 from statictext within w_enviar_transferencia_unomotor
end type
type dw_2 from datawindow within w_enviar_transferencia_unomotor
end type
type st_6 from statictext within w_enviar_transferencia_unomotor
end type
type em_1 from editmask within w_enviar_transferencia_unomotor
end type
type dw_3 from uo_dw_basic within w_enviar_transferencia_unomotor
end type
type st_7 from statictext within w_enviar_transferencia_unomotor
end type
type sle_2 from singlelineedit within w_enviar_transferencia_unomotor
end type
type st_8 from statictext within w_enviar_transferencia_unomotor
end type
type dw_4 from datawindow within w_enviar_transferencia_unomotor
end type
type st_9 from statictext within w_enviar_transferencia_unomotor
end type
type dw_vehiculos from uo_dw_basic within w_enviar_transferencia_unomotor
end type
type dw_5 from datawindow within w_enviar_transferencia_unomotor
end type
type st_10 from statictext within w_enviar_transferencia_unomotor
end type
type st_11 from statictext within w_enviar_transferencia_unomotor
end type
type st_12 from statictext within w_enviar_transferencia_unomotor
end type
type st_13 from statictext within w_enviar_transferencia_unomotor
end type
type ln_1 from line within w_enviar_transferencia_unomotor
end type
end forward
...
global w_enviar_transferencia_unomotor w_enviar_transferencia_unomotor
...
on w_enviar_transferencia_unomotor.create
int iCurrent
call super::create
...
on w_enviar_transferencia_unomotor.destroy
call super::destroy
      ...
      select nvl(it_costo,0),nvl(y.it_stock,0)
	   into   :lc_costo,:ll_existencia
		...
		if isnull(l_status_transferencia) or l_status_transferencia = '' then
	     ...
	     /*Registra la existencia antes de enviar para obtener la demanda insatisfecha posteriormente*/
	   ...
	   End if
		...
		/*Para todos los estados diferentes a Packing list = Pedido = E*/
		...
		if isnull(l_status_transferencia) or l_status_transferencia ='' or l_status_transferencia = 'X' then
			 if lch_kit = 'S' then
					if lc_stock > 0 and ld_cantatomo > 0 then
								...
								lc_costprom =  f_costprom(ls_codigo,'E',lc_stock,lc_costprom)
						  	    if wf_mov_inventario(ls_codigo,lc_stock,f_hoy(),long(ls_ticket),ls_sucursal_destino,&
															...
															ld_cantatomo,ld_costo_atomo,ls_codant,lc_costo,lc_costprom) = false Then
									rollback;
									dw_movim.reset()
...
If l_status_transferencia = 'E' then                  //Pedido
dw_master.SetItem(li_filact, 'tf_aceptada','X') //Marca para indicar que falta descargar y registrar los mov en el lKardex
else
...
type dw_master from w_sheet_master_detail`dw_master within w_enviar_transferencia_unomotor
integer x = 9
integer y = 40
integer width = 2779
integer height = 472
...
type dw_detail from w_sheet_master_detail`dw_detail within w_enviar_transferencia_unomotor
...
type dw_report from w_sheet_master_detail`dw_report within w_enviar_transferencia_unomotor
integer x = 9
integer y = 108
integer width = 2697
integer height = 2112
