CREATE OR REPLACE PROCEDURE DINAMIC.SP_INV_MOV_INVENTARIO (av_empresa varchar, av_sucursal varchar, av_bodega varchar ,av_tipomov varchar,av_escodigo varchar,av_nrodocref number, ab_flag out varchar2, an_stkreal out number,av_codant out varchar2) IS
