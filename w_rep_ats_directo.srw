HA$PBExportHeader$w_rep_ats_directo.srw
$PBExportComments$Si.
forward
global type w_rep_ats_directo from w_sheet_1_dw_rep
end type
type st_1 from statictext within w_rep_ats_directo
end type
type dw_2 from datawindow within w_rep_ats_directo
end type
type cb_4 from commandbutton within w_rep_ats_directo
end type
type dw_3 from datawindow within w_rep_ats_directo
end type
type tab_1 from tab within w_rep_ats_directo
end type
...
type cbx_powerfilter_ats from u_powerfilter_checkbox within w_rep_ats_directo
end type
type cbx_powerfilter_vtas from u_powerfilter_checkbox within w_rep_ats_directo
end type
type cbx_powerfilter_anu from u_powerfilter_checkbox within w_rep_ats_directo
end type
type cbx_powerfilter_reoc from u_powerfilter_checkbox within w_rep_ats_directo
end type
type cbx_vista from u_powerfilter_checkbox within w_rep_ats_directo
end type
type cb_1 from commandbutton within w_rep_ats_directo
end type
type gb_1 from groupbox within w_rep_ats_directo
end type
type dw_1 from datawindow within w_rep_ats_directo
end type
type hpb_1 from hprogressbar within w_rep_ats_directo
end type
type st_3 from statictext within w_rep_ats_directo
end type
type cb_2 from commandbutton within w_rep_ats_directo
end type
type cb_3 from commandbutton within w_rep_ats_directo
end type
type dw_xml from datawindow within w_rep_ats_directo
end type
type cb_8 from commandbutton within w_rep_ats_directo
end type
type cb_9 from commandbutton within w_rep_ats_directo
end type
end forward
...
global w_rep_ats_directo w_rep_ats_directo

type variables
String is_anio,is_mes,is_periodo
end variables

on w_rep_ats_directo.create
int iCurrent
call super::create
...
type dw_datos from w_sheet_1_dw_rep`dw_datos within w_rep_ats_directo
...
type dw_report from w_sheet_1_dw_rep`dw_report within w_rep_ats_directo
integer x = 192
integer y = 924
integer taborder = 60
...
type dw_asiento from w_sheet_1_dw_rep`dw_asiento within w_rep_ats_directo
integer x = 1134
integer y = 912
integer width = 722
integer height = 564
...
tab_1.tabpage_1.dw_ats_compras.SetTransObject(sqlca)
tab_1.tabpage_1.dw_ats_compras.retrieve(ls_periodo)
...
integer taborder = 10
string title = "none"
string dataobject = "d_ats_directo_compras"
boolean vscrollbar = true
...
tab_1.tabpage_2.dw_ats_vtas.setTransObject(sqlca)
tab_1.tabpage_2.dw_ats_vtas.retrieve(ls_periodo,lc_iva)
w_marco.SetMicrohelp("Listo....")
end event
...
integer taborder = 10
string title = "none"
string dataobject = "d_ats_directo_vtas"
...
tab_1.tabpage_3.dw_ats_anulados.setTransObject(sqlca)
tab_1.tabpage_3.dw_ats_anulados.retrieve(ls_periodo)
w_marco.SetMicrohelp("Listo....")
COMMIT;
SetPointer(Arrow!)
...
integer taborder = 20
string title = "none"
string dataobject = "d_ats_directo_anulados"
boolean hscrollbar = true
boolean vscrollbar = true
boolean border = false
boolean hsplitscroll = true
...
//		 next   
		...
		for i =  1 to li_cc
			...
			oleChild.worksheets(6 ).cells(li_fila,13).value =  ldw_vtas.object.iva[ i ] //montoiva
			oleChild.worksheets(6 ).cells(li_fila,14).value = 0.00 //monto ice
			oleChild.worksheets(6 ).cells(li_fila,15).value = ldw_vtas.object.valretiva[ i ] //valorretiva
