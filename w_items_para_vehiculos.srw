HA$PBExportHeader$w_items_para_vehiculos.srw
$PBExportComments$Si.Mantenimiento del maestro de inventarios
forward
global type w_items_para_vehiculos from w_sheet_master_tabpage_detail
end type
type tabpage_detail5 from userobject within tab_detail
end type
type dw_detail5 from datawindow within tabpage_detail5
end type
type tabpage_detail5 from userobject within tab_detail
dw_detail5 dw_detail5
end type
type dw_ubica from datawindow within w_items_para_vehiculos
end type
end forward
...
global w_items_para_vehiculos w_items_para_vehiculos
...
on w_items_para_vehiculos.create
int iCurrent
call super::create
...
on w_items_para_vehiculos.destroy
call super::destroy
...
type dw_master from w_sheet_master_tabpage_detail`dw_master within w_items_para_vehiculos
...
event dw_master::rowfocuschanged;if currentrow = 0 then return
tab_detail.tabpage_detail5.dw_detail5.reset()
tab_detail.tabpage_detail5.dw_detail5.retrieve(this.object.it_codigo[currentrow])
return 1
end event

event dw_master::updateend;call super::updateend;//Reubicar este codigo
...
type dw_report from w_sheet_master_tabpage_detail`dw_report within w_items_para_vehiculos
integer x = 14
integer y = 32
integer width = 3026
integer height = 1524
...
type tab_detail from w_sheet_master_tabpage_detail`tab_detail within w_items_para_vehiculos
integer x = 0
integer y = 1120
integer width = 3529
integer height = 892
integer taborder = 20
tabpage_detail5 tabpage_detail5
end type

on tab_detail.create
this.tabpage_detail5=create tabpage_detail5
int iCurrent
call super::create
iCurrent=UpperBound(this.Control)
this.Control[iCurrent+1]=this.tabpage_detail5
end on

on tab_detail.destroy
call super::destroy
destroy(this.tabpage_detail5)
end on
...
on tabpage_detail5.create
this.dw_detail5=create dw_detail5
this.Control[]={this.dw_detail5}
end on

on tabpage_detail5.destroy
destroy(this.dw_detail5)
end on
...
integer taborder = 40
string title = "none"
string dataobject = "d_vh_partes_2"
boolean livescroll = true
end type

event constructor;this.SetTransobject(sqlca)

f_recupera_empresa(this,"it_codigo")
f_recupera_empresa(this,"it_codigo_1")
f_recupera_empresa(this,"mo_codigo")

this.object.it_codigo.visible = false
this.object.it_codigo_1.visible = false
this.object.b_1.visible = false
this.object.b_2.visible = false
this.object.b_3.visible = false
end event
...
for i = 1 to this.rowcount()
	this.object.it_codigo[i] = dw_master.object.it_codigo[dw_master.getrow()]
next
return 0
end event
...
tab_detail.tabpage_detail3.dw_detail3.reset()
tab_detail.tabpage_detail4.dw_detail4.reset()
messagebox("Error","C$$HEX1$$f300$$ENDHEX$$digo ingresado no existe")
return
End if
