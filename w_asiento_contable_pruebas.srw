HA$PBExportHeader$w_asiento_contable_pruebas.srw
$PBExportComments$Si. Vale
forward
global type w_asiento_contable_pruebas from w_sheet_master_detail
end type
type dw_ubica from datawindow within w_asiento_contable_pruebas
end type
type cb_3 from commandbutton within w_asiento_contable_pruebas
end type
type dw_maux from datawindow within w_asiento_contable_pruebas
end type
type dw_detaux from datawindow within w_asiento_contable_pruebas
end type
type st_2 from statictext within w_asiento_contable_pruebas
end type
type cb_1 from commandbutton within w_asiento_contable_pruebas
end type
end forward
...
global w_asiento_contable_pruebas w_asiento_contable_pruebas
...
on w_asiento_contable_pruebas.create
int iCurrent
call super::create
...
on w_asiento_contable_pruebas.destroy
call super::destroy
...
type dw_master from w_sheet_master_detail`dw_master within w_asiento_contable_pruebas
...
event dw_master::updatestart;integer li_count
select count(1) into :li_count from co_cabcom;
...
type dw_detail from w_sheet_master_detail`dw_detail within w_asiento_contable_pruebas
...
type dw_report from w_sheet_master_detail`dw_report within w_asiento_contable_pruebas
integer y = 0
integer width = 3589
