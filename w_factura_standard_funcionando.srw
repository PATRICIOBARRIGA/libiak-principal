HA$PBExportHeader$w_factura_standard_funcionando.srw
$PBExportComments$Respaldo de w_factura_standard
forward
global type w_factura_standard_funcionando from w_sheet_master_detail
end type
type cb_ubicacion from commandbutton within w_factura_standard_funcionando
end type
type cb_1 from commandbutton within w_factura_standard_funcionando
end type
type cb_2 from commandbutton within w_factura_standard_funcionando
end type
type cb_3 from commandbutton within w_factura_standard_funcionando
end type
type cb_formpag from commandbutton within w_factura_standard_funcionando
end type
type dw_sel_numero from datawindow within w_factura_standard_funcionando
end type
type p_ubicacion from picture within w_factura_standard_funcionando
end type
type dw_movim from datawindow within w_factura_standard_funcionando
end type
type dw_consulta_stk from datawindow within w_factura_standard_funcionando
end type
type p_producto from picture within w_factura_standard_funcionando
end type
type sle_1 from singlelineedit within w_factura_standard_funcionando
end type
type cb_4 from commandbutton within w_factura_standard_funcionando
end type
type pb_1 from picturebutton within w_factura_standard_funcionando
end type
type st_1 from statictext within w_factura_standard_funcionando
end type
type st_plazo from statictext within w_factura_standard_funcionando
end type
type st_2 from statictext within w_factura_standard_funcionando
end type
type cb_5 from commandbutton within w_factura_standard_funcionando
end type
type dw_1 from datawindow within w_factura_standard_funcionando
end type
type dw_pedidos from datawindow within w_factura_standard_funcionando
end type
type dw_tinte from datawindow within w_factura_standard_funcionando
end type
type dw_detalle_pago from uo_dw_detail within w_factura_standard_funcionando
end type
end forward
...
integer width = 7488
integer height = 1972
string title = "Factura Standard 22.01.2K15 con SP - IVA"
...
global w_factura_standard_funcionando w_factura_standard_funcionando
...
dw_report.Modify("DataWindow.Footer.Height=350")
//dw_rep_ticket.Retrieve(gs_estado,str_appgeninfo.empresa,str_appgeninfo.sucursal,str_appgeninfo.seccion,ll_num_venta,tasa.iva*100)
...
on w_factura_standard_funcionando.create
int iCurrent
call super::create
...
on w_factura_standard_funcionando.destroy
call super::destroy
...
type dw_master from w_sheet_master_detail`dw_master within w_factura_standard_funcionando
integer x = 0
integer y = 0
integer width = 7410
integer height = 748
...
decimal lc_subtotal,ld_valor,lc_iva,lc_cargo,lc_valpag
gb_codigo_numerico = true
...
type dw_detail from w_sheet_master_detail`dw_detail within w_factura_standard_funcionando
...
//
    ...
    select ma_codigo,it_tiemsec,it_codigo, it_nombre, it_prefab, it_valstk,it_kit,it_costo,it_codant,it_base,ub_codigo
	into :ls_marca,:li_ivaitem,:ls_pepa, :ls_nombre, :lc_prefab, :ls_valstk,:lch_kit,:ic_costo,:ls_codant,:ls_base,:ls_medida	
	from in_item
	where em_codigo = :str_appgeninfo.empresa
...
type dw_report from w_sheet_master_detail`dw_report within w_factura_standard_funcionando
integer x = 105
integer y = 4
integer width = 2784
integer height = 732
integer taborder = 0
string dataobject = "dw_factura_redcolor_fpos"
