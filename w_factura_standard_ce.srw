HA$PBExportHeader$w_factura_standard_ce.srw
$PBExportComments$Con Stored procedure para aligerar , incluye nro de serie para factura electronica
forward
global type w_factura_standard_ce from w_sheet_master_detail
end type
type cb_ubicacion from commandbutton within w_factura_standard_ce
end type
type cb_1 from commandbutton within w_factura_standard_ce
end type
type cb_2 from commandbutton within w_factura_standard_ce
end type
type cb_3 from commandbutton within w_factura_standard_ce
end type
type cb_formpag from commandbutton within w_factura_standard_ce
end type
type dw_sel_numero from datawindow within w_factura_standard_ce
end type
type p_ubicacion from picture within w_factura_standard_ce
end type
type dw_movim from datawindow within w_factura_standard_ce
end type
type dw_consulta_stk from datawindow within w_factura_standard_ce
end type
type p_producto from picture within w_factura_standard_ce
end type
type sle_1 from singlelineedit within w_factura_standard_ce
end type
type cb_4 from commandbutton within w_factura_standard_ce
end type
type pb_1 from picturebutton within w_factura_standard_ce
end type
type st_1 from statictext within w_factura_standard_ce
end type
type st_plazo from statictext within w_factura_standard_ce
end type
type st_2 from statictext within w_factura_standard_ce
end type
type cb_5 from commandbutton within w_factura_standard_ce
end type
type dw_1 from datawindow within w_factura_standard_ce
end type
type dw_pedidos from datawindow within w_factura_standard_ce
end type
type dw_tinte from datawindow within w_factura_standard_ce
end type
type dw_detalle_pago from uo_dw_detail within w_factura_standard_ce
end type
end forward
...
integer width = 7488
integer height = 1972
string title = "Factura Standard 14.04.2k14 con SP - IVA"
...
global w_factura_standard_ce w_factura_standard_ce
...
on w_factura_standard_ce.create
int iCurrent
call super::create
...
on w_factura_standard_ce.destroy
call super::destroy
...
dw_master.setitem(li_filact,"ve_serie",ls_numserie)
...
type dw_master from w_sheet_master_detail`dw_master within w_factura_standard_ce
integer x = 0
integer y = 0
integer width = 7410
integer height = 748
...
type dw_detail from w_sheet_master_detail`dw_detail within w_factura_standard_ce
...
type dw_report from w_sheet_master_detail`dw_report within w_factura_standard_ce
integer x = 105
integer y = 4
integer width = 2784
integer height = 732
integer taborder = 0
string dataobject = "dw_factura_pintamax_a4"
