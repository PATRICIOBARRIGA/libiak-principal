HA$PBExportHeader$w_compras_y_cxp.srw
$PBExportComments$Pendiente.Si.Actualmente trabajando(10/01/07)Compras de productos de una empresa.Vale
forward
global type w_compras_y_cxp from w_sheet_master_tabpage_detail
end type
type dw_compra from datawindow within w_compras_y_cxp
end type
type dw_ubica from datawindow within w_compras_y_cxp
end type
type dw_listarecep from datawindow within w_compras_y_cxp
end type
type shl_1 from statichyperlink within w_compras_y_cxp
end type
type shl_2 from statichyperlink within w_compras_y_cxp
end type
type uo_cre from uo_cxp within w_compras_y_cxp
end type
end forward
...
global w_compras_y_cxp w_compras_y_cxp
...
if this.ib_inReportMode then
	...
	ldw_detail.resize(li_width - 20 ,li_height -900)
end if
this.setRedraw(True)
end event

type dw_master from w_sheet_master_tabpage_detail`dw_master within w_compras_y_cxp
integer width = 4352
integer height = 680
...
type dw_report from w_sheet_master_tabpage_detail`dw_report within w_compras_y_cxp
integer x = 2510
integer y = 1196
string dataobject = "d_rep_compra"
end type

type tab_detail from w_sheet_master_tabpage_detail`tab_detail within w_compras_y_cxp
integer x = 0
integer y = 708
integer width = 4352
integer height = 1604
