HA$PBExportHeader$w_consulta_tomafisica.srw
$PBExportComments$Si.Vale
forward
global type w_consulta_tomafisica from window
end type
type dw_2 from datawindow within w_consulta_tomafisica
end type
type cb_1 from commandbutton within w_consulta_tomafisica
end type
type st_dw_mode from statictext within w_consulta_tomafisica
end type
type cb_action from commandbutton within w_consulta_tomafisica
end type
type dw_1 from datawindow within w_consulta_tomafisica
end type
end forward
...
string title = "Consulta de Toma F$$HEX1$$ed00$$ENDHEX$$sica"
...
global w_consulta_tomafisica w_consulta_tomafisica
...
on w_consulta_tomafisica.create
...
on w_consulta_tomafisica.destroy
destroy(this.dw_2)
destroy(this.cb_1)
...
integer taborder = 10
string title = "none"
string dataobject = "d_consul_toma"
boolean vscrollbar = true
...
ls_numero      = This.GetItemString(currentrow,"ts_numero")
ls_sucodigo    = This.GetItemString(currentrow,"su_codigo")
ls_bocodigo    = This.GetItemString(currentrow,"bo_codigo")

dw_2.Retrieve(str_appgeninfo.empresa,ls_sucodigo,ls_bocodigo,ls_numero)
...
ls_numero    = This.GetItemString(1,"ts_numero")
