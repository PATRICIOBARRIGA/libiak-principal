HA$PBExportHeader$w_notaentrega.srw
$PBExportComments$Facturas al por mayor
forward
global type w_notaentrega from w_sheet_master_detail
end type
type cb_ubicacion from commandbutton within w_notaentrega
end type
type cb_1 from commandbutton within w_notaentrega
end type
type cb_2 from commandbutton within w_notaentrega
end type
type cb_3 from commandbutton within w_notaentrega
end type
type cb_formpag from commandbutton within w_notaentrega
end type
type dw_sel_numero from datawindow within w_notaentrega
end type
type p_ubicacion from picture within w_notaentrega
end type
type dw_movim from datawindow within w_notaentrega
end type
type dw_detalle_pago from uo_dw_detail within w_notaentrega
end type
type dw_consulta_stk from datawindow within w_notaentrega
end type
type p_producto from picture within w_notaentrega
end type
type dw_1 from datawindow within w_notaentrega
end type
type sle_1 from singlelineedit within w_notaentrega
end type
type cb_4 from commandbutton within w_notaentrega
end type
type pb_1 from picturebutton within w_notaentrega
end type
type dw_pedidos from datawindow within w_notaentrega
end type
type st_1 from statictext within w_notaentrega
end type
type st_plazo from statictext within w_notaentrega
end type
type st_2 from statictext within w_notaentrega
end type
type cb_5 from commandbutton within w_notaentrega
end type
end forward
...
integer width = 5317
integer height = 1924
string title = "Factura con Promociones"
...
global w_notaentrega w_notaentrega
...
this.Control[iCurrent+9]=this.dw_detalle_pago
this.Control[iCurrent+10]=this.dw_consulta_stk
this.Control[iCurrent+11]=this.p_producto
...
this.Control[iCurrent+16]=this.dw_pedidos
this.Control[iCurrent+17]=this.st_1
this.Control[iCurrent+18]=this.st_plazo
this.Control[iCurrent+19]=this.st_2
this.Control[iCurrent+20]=this.cb_5
end on

on w_notaentrega.destroy
call super::destroy
...
type dw_master from w_sheet_master_detail`dw_master within w_notaentrega
integer x = 0
integer y = 0
integer width = 5202
integer height = 708
...
type dw_detail from w_sheet_master_detail`dw_detail within w_notaentrega
...
case 'codant' 
   ...
   if sqlca.sqlcode <> 0 then
		//luego por codigo de barras
		 select ma_codigo,it_tiemsec,it_preparado,it_codigo, it_codant, it_nombre, it_prefab, it_valstk,nvl(it_costo,0),it_kit,it_base
		 into :ls_marca,:li_ivaitem,:lch_cambia,:ls_pepa, :ls_codant, :ls_nombre, :lc_prefab, :ls_valstk, :ic_costo, :lch_kit, :ls_base
		 from in_item
		 where em_codigo = :str_appgeninfo.empresa
		 and it_codbar = :ls;
...
//	ll_find = dw_2.find("it_codigo = '"+ls_pepa+"'",1,dw_2.rowcount())
	...
	if lch_kit = 'V' then
		openwithparm(w_venta_vehiculo,ls)
...
type dw_report from w_sheet_master_detail`dw_report within w_notaentrega
integer x = 105
integer y = 4
integer width = 2784
integer height = 732
integer taborder = 0
string dataobject = "dw_notaentrega_tecnicolor"
