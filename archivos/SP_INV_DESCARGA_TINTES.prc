...
ls_movdescri := 'Factura de venta Nº. ';
...
ad_cantidad := reg1.dv_candes;
                ...
                VALUES(av_tipomov,ls_ioe,reg2.it_codigo,av_empresa,av_sucursal,av_bodega,ln_nromovim,ad_cantidad,reg2.it_costo,sysdate,ls_movdescri||av_nrodocref,av_nrodocref,av_escodigo,'N');
