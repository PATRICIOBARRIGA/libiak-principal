HA$PBExportHeader$w_ajuste_inv_new.srw
$PBExportComments$Si.
forward
global type w_ajuste_inv_new from w_sheet_master_detail
end type
type dw_ubica from datawindow within w_ajuste_inv_new
end type
type dw_movim from datawindow within w_ajuste_inv_new
end type
end forward
...
global w_ajuste_inv_new w_ajuste_inv_new
...
setnull(ls_nulo)
ls_observa = "Ajuste de "+as_signomov+". No. "+string(il_numero)+" de "+is_nombodega
// busca si el item es kit o no 
if ach_kit = 'S' then
	// es un kit
	ls_obs_kit = "Ajuste de "+as_signomov+". del kit "+is_codant1+" No. "+string(il_numero)+" de "+is_nombodega
...
type dw_master from w_sheet_master_detail`dw_master within w_ajuste_inv_new
integer x = 0
integer y = 4
integer width = 3392
integer height = 356
integer taborder = 10
string dataobject = "d_cab_ajuste_inv"
...
type dw_detail from w_sheet_master_detail`dw_detail within w_ajuste_inv_new
integer x = 0
integer y = 360
integer width = 3392
integer height = 1088
...
type dw_report from w_sheet_master_detail`dw_report within w_ajuste_inv_new
integer x = 0
integer y = 0
integer width = 2331
integer height = 1408
