HA$PBExportHeader$w_rep_comisiones_x_asesor.srw
$PBExportComments$Si.En produccion comisiones por asesor parametrizada
forward
global type w_rep_comisiones_x_asesor from w_sheet_1_dw_rep
end type
type rb_1 from radiobutton within w_rep_comisiones_x_asesor
end type
type rb_2 from radiobutton within w_rep_comisiones_x_asesor
end type
type st_1 from statictext within w_rep_comisiones_x_asesor
end type
type cbx_1 from checkbox within w_rep_comisiones_x_asesor
end type
type st_2 from statictext within w_rep_comisiones_x_asesor
end type
type cbx_2 from checkbox within w_rep_comisiones_x_asesor
end type
type cbx_3 from checkbox within w_rep_comisiones_x_asesor
end type
type cbx_4 from checkbox within w_rep_comisiones_x_asesor
end type
type cbx_5 from checkbox within w_rep_comisiones_x_asesor
end type
end forward
...
global w_rep_comisiones_x_asesor w_rep_comisiones_x_asesor

on w_rep_comisiones_x_asesor.create
int iCurrent
call super::create
...
on w_rep_comisiones_x_asesor.destroy
call super::destroy
destroy(this.rb_1)
destroy(this.rb_2)
destroy(this.st_1)
...
type dw_datos from w_sheet_1_dw_rep`dw_datos within w_rep_comisiones_x_asesor
integer x = 0
integer y = 320
integer width = 3232
integer height = 1248
...
type dw_report from w_sheet_1_dw_rep`dw_report within w_rep_comisiones_x_asesor
integer y = 724
end type

type dw_asiento from w_sheet_1_dw_rep`dw_asiento within w_rep_comisiones_x_asesor
end type
