HA$PBExportHeader$w_plan_cuentas_niff.srw
$PBExportComments$Si. Vale  con soporte para cuentas NIFF
forward
global type w_plan_cuentas_niff from w_sheet_1_dw_maint
end type
type sle_1 from singlelineedit within w_plan_cuentas_niff
end type
type st_2 from statictext within w_plan_cuentas_niff
end type
type st_3 from statictext within w_plan_cuentas_niff
end type
type sle_2 from singlelineedit within w_plan_cuentas_niff
end type
type st_4 from statictext within w_plan_cuentas_niff
end type
type cb_1 from commandbutton within w_plan_cuentas_niff
end type
end forward
...
global w_plan_cuentas_niff w_plan_cuentas_niff
...
on w_plan_cuentas_niff.destroy
call super::destroy
destroy(this.sle_1)
destroy(this.st_2)
destroy(this.st_3)
...
type dw_datos from w_sheet_1_dw_maint`dw_datos within w_plan_cuentas_niff
integer y = 168
integer width = 5193
integer height = 1460
string dataobject = "d_plan_cuentas_NIFF"
boolean border = true
end type
...
type dw_report from w_sheet_1_dw_maint`dw_report within w_plan_cuentas_niff
integer x = 14
integer y = 12
integer width = 3648
integer height = 1620
